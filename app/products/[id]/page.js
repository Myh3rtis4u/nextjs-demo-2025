...
export default function ProductDetail() {
  ...
  return (
    <div className="bg-slate-100 flex flex-column h-auto justify-center gap-4 m-auto p-[1rem] max-w-[600px]">
      <p className="text-2xl font-bold text-center text-slate-700">Details</p>
...
// params ดึงไอดีจาก product id
// formatStars return รูปดาว
// justify-between 2 span จะอยู่ระหว่างกัน
